        ...
        <section className="w-full py-12">
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex flex-col items-center">
                    <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Popular Stores</h1>
                                    ...
                                    .map((store, index) => (
                                        <div key={index} className="flex-shrink-0">
                                            <Link href={`/stores/${store?.id}`} className="group" prefetch={false}>
                                                ...
                                                <div className="mt-2 text-center font-medium">{store.storeName}</div>
                                            </Link>
                                        </div>
                                    ))
                            )}
