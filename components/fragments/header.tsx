    ...
    <section className="w-full py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 max-w-3xl text-center text-muted-foreground md:text-xl">
          </p>
        </div>
            ...
            <div className="flex gap-6">
              {
                loading ? (
                  <Loading />
                    ...
                    stores.filter((store) => store.storeLogo).filter((store, index) => index < 10).map((store, index) => (
